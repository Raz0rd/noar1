    ...
    try {
      ...
      const requestData = {
        ...
        metadata: JSON.stringify({
          ...
          pixelId: "",
          timestamp: new Date().toISOString(),
          isTaxPayment: true, // Identificador para PIX de 40%
          trackingParameters: JSON.parse(localStorage.getItem('utm-params') || '{}')
        }),
        traceable: true,
        ip: "0.0.0.0"
      }
      ...
      <div className="container mx-auto px-4 py-6 sm:py-8 max-w-2xl">
        ...
        {step === 2 && addressData && (
          <div className="space-y-4 sm:space-y-6">
            ...
            {isGasProduct() && (
              <Card ref={paymentExplanationRef} className="overflow-hidden border-0 shadow-lg">
                <div className="bg-gradient-to-r from-blue-600 via-cyan-500 to-green-400 p-4 text-white">
                  <div className="flex items-center gap-2">
                    <span className="text-xl">💳</span>
                    <span className="font-bold">Como Funciona o Pagamento</span>
                  </div>
                </div>
                <CardContent className="pt-4 pb-6">
                  <p className="text-sm text-gray-700 leading-relaxed mb-4">
                    Para garantir o <strong className="text-blue-700">melhor preço</strong>, o pagamento é dividido em 2 partes rápidas via PIX:
                  </p>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-4 border border-blue-200">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1">
                            <h6 className="font-bold text-blue-800 text-sm">Produto + Entrega</h6>
                            <p className="text-xs text-gray-600">Pague agora via PIX</p>
                          </div>
                          <span className="text-xl font-bold text-blue-700">{formatPrice(Math.round((getTotalPrice() - pixDiscount) * 0.60))}</span>
                        </div>
                      </div>

                      {/* Segunda Parte - 40% */}
                      <div className="bg-gradient-to-r from-cyan-50 to-green-50 rounded-xl p-4 border border-cyan-200">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-cyan-600 text-white rounded-full flex items-center justify-center font-bold">2</div>
                          <div className="flex-1">
                            <h6 className="font-bold text-cyan-800 text-sm">Taxas e Impostos</h6>
                            <p className="text-xs text-gray-600">Após confirmar o 1º</p>
                          </div>
                          <span className="text-xl font-bold text-cyan-700">{formatPrice(Math.round((getTotalPrice() - pixDiscount) * 0.40))}</span>
                        </div>
                      </div>

                      {/* Total */}
                      <div className="bg-gradient-to-r from-blue-600 via-cyan-500 to-green-400 rounded-xl p-4 text-white">
                        <div className="flex justify-between items-center">
                          <span className="font-bold">💰 Valor Total:</span>
                          <span className="font-bold text-2xl">{formatPrice(getTotalPrice() - pixDiscount)}</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-2">
                    <div className="flex items-center gap-2 bg-green-50 p-2 rounded-lg">
                      ...
                      <span className="text-xs text-green-800 font-medium">Frete grátis</span>
                    </div>
                    <div className="flex items-center gap-2 bg-blue-50 p-2 rounded-lg">
                      <Clock className="w-4 h-4 text-blue-600" />
                      <span className="text-xs text-blue-800 font-medium">30 min</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="overflow-hidden border-0 shadow-lg" data-payment-method>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200 rounded-xl p-4 mb-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-xs text-gray-600">Valor a pagar agora:</p>
                    ...
                    {requiresSplitPayment() && (
                      <div className="text-right">
                        ...
                        <p className="text-xs text-gray-500">Após 1º pix</p>
                      </div>
                    )}
                  </div>
                  {isGasProduct() && (
